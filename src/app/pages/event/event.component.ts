...
export class EventComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  readonly premiumArtworks: { src: string; title: string; chapter: string; caption: string; }[] = [
    ...
    { src: 'assets/images/anime3.png', title: 'The Garden Walk', chapter: 'Chapter III', caption: 'Side by side, into a softer light.' },
    { src: 'assets/images/anime4.png', title: 'Held',            chapter: 'Chapter IV',  caption: 'In the quiet, an entire world.' },
    { src: 'assets/images/anime5.png', title: 'Lakeside, Dusk',  chapter: 'Chapter V',   caption: 'Two silhouettes, one horizon.' },
    { src: 'assets/images/anime6.png', title: 'Beneath the Tree',chapter: 'Chapter VI',  caption: 'A pause, a smile, a forever.' },
  ];
